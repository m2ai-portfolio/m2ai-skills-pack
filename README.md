...
> **176 portable Claude Code skills** for building, governing, and operating AI agents — architecture, safety, model strategy, cost control, code pipelines, and business analysis. One install, organized into 13 working divisions.

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![Claude Code](https://img.shields.io/badge/Claude%20Code-plugin-blueviolet)](#install) [![Skills](https://img.shields.io/badge/skills-176-brightgreen.svg)](#the-catalog)
...
`0.5.0` -- consolidated SkillForge into the pack (now 176 skills), sanitized for sharing, and reorganized the README into 13 divisions. Feedback welcome.
